...
| **ToCodex** | AI coding assistant for VS Code (extension, IDE, desktop, CLI) with OpenAI-compatible providers, MCP tools, and scheduled automation. | [Guide](./docs/tocodex.md) |
